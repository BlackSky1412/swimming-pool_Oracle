...
public class CourseServiceImpl implements ICourseService {
    ...
    public List<Course> findActiveCourse() {
        return CourseRepository.findActiveCourse();
    }
    ...
    public CourseCreationResponse saveCourse(CourseCreationRequest courseCreationRequest) throws IOException {
        ...
        course.setIs_Show_Home(courseCreationRequest.getIsShowHome());
    ...
    public List<CourseImageDTO> getCourseImage(int limit) {
        return CourseRepository.getCourseImage(limit);
    }

    @Override
    public List<CourseResponse> getBestSeller(int limit) {
        List<CourseResponse> bestSeller = CourseRepository.getBestSeller(limit);
    ...
    public List<CourseResponse> getNewest(int limit) {
        final List<CourseResponse> newest = CourseRepository.getNewest(limit);
    ...
    public List<CourseResponse> getHotSales(int limit) {
        final List<CourseResponse> hotSales = CourseRepository.getHotSales(limit);
